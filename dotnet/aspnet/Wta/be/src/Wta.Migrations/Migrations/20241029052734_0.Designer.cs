...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Dict", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.ExternalApp", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.LoginProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.WorkGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.WorkGroupUser", b =>
                {
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Department", b =>
                {
                    b.HasOne("Wta.Application.SystemModule.Domain.User", "Manager")
                        .WithMany("Departments")
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Wta.Application.SystemModule.Domain.Department", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Wta.Application.SystemModule.Domain.Post", null)
                        .WithMany("Departments")
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Dict", b =>
                {
                    b.HasOne("Wta.Application.SystemModule.Domain.Dict", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.ExternalApp", b =>
                {
                    b.HasOne("Wta.Application.SystemModule.Domain.User", "User")
                        .WithMany("Apps")
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Permission", b =>
                {
                    b.HasOne("Wta.Application.SystemModule.Domain.Permission", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.Post", b =>
                {
                    b.HasOne("Wta.Application.SystemModule.Domain.Department", "Department")
                        .WithMany("Posts")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Wta.Application.SystemModule.Domain.Post", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.RolePermission", b =>
                {
                    b.HasOne("Wta.Application.SystemModule.Domain.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wta.Application.SystemModule.Domain.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.User", b =>
                {
                    ...
                    b.HasOne("Wta.Application.SystemModule.Domain.Post", "Post")
                        .WithMany("Users")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.WorkGroup", b =>
                {
                    b.HasOne("Wta.Application.SystemModule.Domain.WorkGroup", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Wta.Application.SystemModule.Domain.WorkGroupUser", b =>
                {
                    ...
                    b.HasOne("Wta.Application.SystemModule.Domain.WorkGroup", "WorkGroup")
                        .WithMany("WorkGroupUsers")
