...
[Display(Order = -1)]
public class DefaultDbSeeder(IActionDescriptorCollectionProvider actionProvider, IEncryptionService encryptionService, ITenantService tenantService) : IDbSeeder<BaseDbContext>
{
    ...
    private static void InitJob(BaseDbContext context)
    {
